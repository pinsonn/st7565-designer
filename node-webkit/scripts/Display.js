...
// draw the grid on the canvas 
  ...
  this.encode = function(asHTML){
// boolean to include html tags or not
    var html = (asHTML !== undefined) ? asHTML : true;
...
// invert the current buffer

  this.invert = function(){
    for (var i = 0; i < this.stateBuffer.length; i++){
      this.stateBuffer[i] =  (this.stateBuffer[i]) ? 0 : 1;
    }
  },
